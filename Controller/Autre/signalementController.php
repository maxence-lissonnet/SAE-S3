...
// Note: Le modèle DOIT être inclus avant ce contrôleur dans la vue, ou inclus ici.
// Par sécurité, on peut vérifier si les fonctions du modèle existent, ou supposer l'inclusion.
// Dans l'architecture actuelle fournie, c'est la vue qui fait les require.
