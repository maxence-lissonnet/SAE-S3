                        ...
                        <div>
                            <header>
                                ...
                                <p class="logo"><img src="Asset/image/logo/logo point maps.png"
                                        class="logo-icon"><?php echo htmlspecialchars($article['adresseLieuRetrait']); ?>
                                </p>
                                <p class="logo"><img src="Asset/image/logo/logo etat.png"
                                        class="logo-icon"><?php echo htmlspecialchars($article['nomEtatObjet']); ?></p>
                            </header>
                        </div>
                    </section>
                </a>
