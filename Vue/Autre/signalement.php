    ...
    <form method="POST" enctype="multipart/form-data" id="signalementForm">
        <div class="signalement-container">
            ...
            <div class="signalement-info-section">
                ...
                <div class="info-block">
                    <p>Sachez que la demande a dû subir des traitements spécifiques. Vous recevrez un mail de
                        l'Université afin de
                        connaître l'avancement de votre demande régulièrement; ces deux services pour connaître
                        l'avancement de
                        votre demande.</p>
                </div>
